...
return [
    ...
    'filename' => '/home/grav/www/html/user/themes/antimatter-open-publishing/blueprints.yaml',
    'modified' => 1506826799,
    'data' => [
        ...
        'form' => [
            ...
            'fields' => [
                ...
                'method_for_git_sync' => [
                    'type' => 'select',
                    'size' => 'medium',
                    'label' => 'Method for Git Sync',
                    'default' => 1,
                    'options' => [
                        'gitsyncplugin' => 'Git Sync Plugin',
                        'other' => 'Other (e.g. cPanel Git Feature, etc.)'
                    ]
                ],
