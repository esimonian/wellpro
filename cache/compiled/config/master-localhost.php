...
return [
    ...
    'timestamp' => 1509669933,
    'checksum' => 'eb2da4b7cef8d93b8e7338a49fb31a72',
    'files' => [
        'user/config' => [
            'groups' => [
            ...
            'plugins/oe-schema' => [
                'file' => 'user/config/plugins/oe-schema.yaml',
                'modified' => 1506827993
            ],
            ...
            'themes/niazi' => [
                'file' => 'user/config/themes/niazi.yaml',
                'modified' => 1506835174
            ]
        ],
        'system/config' => [
    ...
    'data' => [
        ...
        'themes' => [
            'antimatter-open-publishing' => [
                ...
                'method_for_git_sync' => 'gitsyncplugin',
                'displaypostsummary' => [
                    'enabled' => true
                ],
                'cc_license' => [
